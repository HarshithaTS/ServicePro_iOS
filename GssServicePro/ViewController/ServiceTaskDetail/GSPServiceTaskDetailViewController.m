...
- (void)setupView
{
    ...
    self.bgScrollView.contentSize = CGSizeMake(self.view.bounds.size.width, 1100);
...
//                  cell.descriptionLabelText.frame = CGRectMake(13, 36, 580, 100);
                  cell.descriptionLabelText.frame = CGRectMake(13, 30, 680, 20+((self.serviceTask.serviceNote.length / 110)+1)*21);
